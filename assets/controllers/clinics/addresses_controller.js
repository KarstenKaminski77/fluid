    ...
    onClickToggle(e)
    {
        ...
        if($('.modal-body-address-new:visible').is(':visible')) {
            ...
            $('#modal_header_address').empty()
                ...
                .append('<span class="badge bg-success ms-3 toggle_address" role="button" data-action="click->clinics--addresses#onClickToggle">Use an Existing Address</span>')
                .append('<button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>');
